...
def load_dataframes(train_csv_name):
    ...
    Converts labels to strings ('0', '1') as required by ImageDataGenerator with class_mode='binary'.
    Ensures image file names end with .jpg.
    Performs stratified split on the training set to get validation data.
    """
