...
# === EfficientNet builders with separate head/base dropout & L2 ===

def build_efficientnetb_generic(EfficientNetClass, img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base, use_cbam=False):
...
def build_efficientnetb0(img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base):
    return build_efficientnetb_generic(EfficientNetB0, img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base)

def build_efficientnetb1(img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base):
    return build_efficientnetb_generic(EfficientNetB1, img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base)

def build_efficientnetb2(img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base):
    return build_efficientnetb_generic(EfficientNetB2, img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base)

def build_efficientnetb3(img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base):
    return build_efficientnetb_generic(EfficientNetB3, img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base, use_cbam=True)

def build_efficientnetb4(img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base):
    return build_efficientnetb_generic(EfficientNetB4, img_size, dropout_head, dropout_base, l2_lambda_head, l2_lambda_base, use_cbam=True)
